...
java -cp .;lib/commons-io-1.4.jar;lib/commons-fileupload-1.2.1.jar;lib/commons-codec-1.3.jar;lib/jline-0.9.94.jar;lib/clojure.jar;lib/clojure-contrib.jar;lib/ant.jar;lib/ant-launcher.jar;lib/compojure.jar;lib/hsqldb.jar;lib/jetty-6.1.14.jar;lib/jetty-util-6.1.14.jar;lib/servlet-api-2.5-6.1.14.jar;./classes;./src jline.ConsoleRunner clojure.lang.Repl